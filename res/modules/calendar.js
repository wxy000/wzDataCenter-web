...
(function(){
	var calendar = function(calendarId){
		...
		c.init = function(){
            ...
            .box{margin-left:15px;margin-right:10px;text-align:center;width:100%-25px;height:22px;font-weight:bold;font-size:18px;}\
            ...
            .Tr{color:#ccc;text-align:center;}\
            .redTr{color:red;text-align:center;}\
            .blueTr{color:#1E9FFF;text-align:center;};");
			}
